...
public class TancSoStudentite {
	...
	private static Semaphore maska_garderoba;
	private static Semaphore zenska_garderoba;
	private static Semaphore zenskoTuka;
	private static Semaphore brTancovi;
    

    public void init() {
        //TODO: da se implementira
    	maska_garderoba = new Semaphore(10);
    	zenska_garderoba = new Semaphore(10);
    	zenskoTuka = new Semaphore(0);
    	brTancovi = new Semaphore(3);
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
        	maska_garderoba.acquire();
            show.presobleci();
            maska_garderoba.release();
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
        	zenska_garderoba.acquire();
            show.presobleci();
            zenskoTuka.release();
            zenska_garderoba.release();
